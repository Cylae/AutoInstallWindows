...
try {
    ...
    Set-RegistryKey -Path "${defaultUserHive}\Software\Classes\CLSID\{86ca1aa0-34aa-4e8b-a509-50c905bae2a2}\InprocServer32" -Name "Dummy" -Value "Dummy"; Remove-ItemProperty -Path "Registry::$defaultUserHive\Software\Classes\CLSID\{86ca1aa0-34aa-4e8b-a509-50c905bae2a2}\InprocServer32" -Name "Dummy" -ErrorAction SilentlyContinue; Set-Item -Path "Registry::$defaultUserHive\Software\Classes\CLSID\{86ca1aa0-34aa-4e8b-a509-50c905bae2a2}\InprocServer32" -Value ""
