...
try {
    ...
    Set-RegistryKey -Path "$defaultUserHive\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "TaskbarAl" -Value "0" -Type "DWord"
    Set-RegistryKey -Path "$defaultUserHive\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "LaunchTo" -Value "1" -Type "DWord"
    ...
    Set-RegistryKey -Path "$defaultUserHive\Software\Microsoft\Windows\CurrentVersion\Search" -Name "SearchboxTaskbarMode" -Value "3" -Type "DWord"
    Set-RegistryKey -Path "$defaultUserHive\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "TaskbarDa" -Value "0" -Type "DWord"
    Set-RegistryKey -Path "$defaultUserHive\Software\Microsoft\Windows\CurrentVersion\Explorer\Advanced" -Name "TaskbarMn" -Value "0" -Type "DWord"
    ...
    Set-RegistryKey -Path "$defaultUserHive\Software\Classes\CLSID\{86ca1aa0-34aa-4e8b-a509-50c905bae2a2}\InprocServer32" -Name "(default)" -Value "" -Type "String"
