...
# Disable Windows Error Reporting, Shared Experiences, Consumer Features, Activity History
reg.exe add "HKLM\SOFTWARE\Policies\Microsoft\Windows\WindowsErrorReporting" /v Disabled /t REG_DWORD /d 1 /f
