...
def update_autounattend(ssid=None, password=None):
    ...
    for script_file in scripts_dir.rglob('*.ps1'):
        ...
        if re.search(pattern, content, re.DOTALL):
            ...
            logger.info(f"File path {target_path_str} not found in XML. Appending it...")
            ...
            if re.search(extensions_close_pattern, content):
                ...
                logger.error("Error: </Extensions> tag not found in autounattend.xml. Cannot append new script.")
    ...
    if ssid and password:
        ...
        if match_specialize:
            ...
            logger.error("Error: <settings pass=\"specialize\"> not found in autounattend.xml. Cannot inject WiFi.")
