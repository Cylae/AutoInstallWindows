...
*   **Linting & Testing**: The project uses `pytest` for executing unit tests, `flake8` for linting, and `autopep8` for formatting Python code.
...
*   **Tests & Qualité**: Le projet utilise `pytest` pour les tests unitaires, `flake8` pour l'analyse statique du code, et `autopep8` pour le formatage.
