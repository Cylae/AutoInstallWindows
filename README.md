...
*   **🛡️ Privacy Hardened**: Disables Telemetry, **Recall** (AI Screenshot), Copilot, Bing Search, Cortana, Advertising ID, **Search Highlights**, **Widgets**, **File Explorer Ads**, **Typing Insights**, **Tailored Experiences**, and **Tips/Suggestions**. Disables **Windows Error Reporting**, **Shared Experiences**, **Consumer Features**, and **Activity History**. **Restores Classic Context Menu** (Windows 11) and shows file extensions by default.
...
*   **🚀 System Optimization**:
    ...
    *   **App Launch Tracking**: Disables App Launch Tracking (`NoInstrumentation` and `DisableMFUTracking`).
...
*   **🛡️ Confidentialité Renforcée**: Désactive la télémétrie, **Recall** (Capture d'écran IA), Copilot, la recherche Bing, Cortana, l'ID publicitaire, **Widgets**, **Publicités Explorateur**, **Aperçus de saisie**, **Expériences sur mesure**, et **Astuces**. Désactive le **Rapport d'erreurs Windows**, les **Expériences partagées**, les **Fonctionnalités grand public**, et l'**Historique des activités**. **Restaure le menu contextuel classique** (Windows 11) et affiche les extensions de fichiers.
...
*   **🚀 Optimisation Système**:
    ...
    *   **Suivi Lancement Application**: Désactive le suivi de lancement des applications (`NoInstrumentation` et `DisableMFUTracking`).
