...
*   **🛡️ Privacy Hardened**: Disables Telemetry, **Recall** (AI Screenshot), Copilot, Bing Search, Cortana, Advertising ID, **Search Highlights**, **Widgets**, **File Explorer Ads**, **Tips/Suggestions**, **Windows Error Reporting**, **Shared Experiences**, and **Typing Insights**. **Restores Classic Context Menu** (Windows 11) and shows file extensions by default.
...
*   **🚀 System Optimization**:
    ...
    *   **Privacy & Performance**: Disables App Launch Tracking.
...
*   **🛡️ Confidentialité Renforcée**: Désactive la télémétrie, **Recall** (Capture d'écran IA), Copilot, la recherche Bing, Cortana, l'ID publicitaire, **Widgets**, **Publicités Explorateur**, **Astuces**, **Rapport d'erreurs Windows**, **Expériences partagées**, et **Typing Insights**. **Restaure le menu contextuel classique** (Windows 11) et affiche les extensions de fichiers.
...
*   **🚀 Optimisation Système**:
    ...
    *   **Confidentialité & Performance**: Désactive le suivi de lancement des applications.
