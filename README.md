...
This repository uses the following tools for development:

*   **pytest**: For running unit tests. Use the command `pytest` to execute all tests.
*   **flake8**: For linting Python code to ensure PEP 8 compliance. Use the command `flake8`.
*   **autopep8**: For automatically formatting Python code. A helper script `fix_flake8.sh` is provided to install and run `autopep8` and correct formatting issues.
