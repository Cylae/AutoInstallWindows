...
*   **Lint**: Run `flake8 .` to check for formatting issues.
...
*   **Test**: Exécutez `pytest` pour lancer les tests unitaires.
*   **Lint**: Exécutez `flake8 .` pour vérifier les problèmes de formatage.
