...
*   **🛡️ Enhanced Robustness**:
    ...
    *   **Advanced Error Handling**: Improved logging and robust registry handling via custom `Set-RegistryKey` helper for fail-safe execution.
...
*   **🛡️ Robustesse Améliorée**:
    ...
    *   **Gestion d'Erreurs Avancée**: Journaux améliorés et gestion robuste du registre via la fonction d'aide personnalisée `Set-RegistryKey` pour une exécution sans faille.
