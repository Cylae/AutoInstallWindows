...
*   **🛡️ Enhanced Robustness**:
    ...
    *   **Advanced Error Handling**: Improved logging and robust native PowerShell registry handling (replacing `reg.exe`) for fail-safe execution.
...
*   **🛡️ Robustesse Améliorée**:
    ...
    *   **Gestion d'Erreurs Avancée**: Journaux améliorés et gestion native robuste du registre PowerShell (remplaçant `reg.exe`) pour une exécution sans faille.
