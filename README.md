...
*   **Linting/Testing**: Run `pytest` for unit tests, `flake8` for linting, and `autopep8` for formatting Python code.
...
*   **Tests/Formatage**: Exécutez `pytest` pour les tests unitaires, `flake8` pour le linting, et `autopep8` pour formater le code Python.
