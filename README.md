...
*   **Personalization GUI**: Modify `personalize.py` if you wish to adjust the interactive GUI.
*   **Testing**: We use `pytest` for unit testing and `flake8` for linting. You can format the code with `autopep8`. Example: `pytest` and `flake8 .`
...
*   **GUI de Personnalisation**: Modifiez `personalize.py` si vous souhaitez ajuster l'interface interactive.
*   **Tests**: Nous utilisons `pytest` pour les tests unitaires et `flake8` pour le linting. Vous pouvez formater le code avec `autopep8`. Exemple : `pytest` et `flake8 .`
