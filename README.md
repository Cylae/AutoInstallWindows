...
*   **🚀 System Optimization**:
    ...
    *   **Space Saving**: Disables Hibernation and Fast Startup to save disk space (`hiberfil.sys`).
...
*   **🚀 Optimisation Système**:
    ...
    *   **Gain d'Espace**: Désactive l'hibernation et le démarrage rapide pour économiser de l'espace disque (`hiberfil.sys`).
