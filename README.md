...
*   **Add**: Create new `.ps1` files in `scripts/`. They will be automatically added to the XML during build.
...
*   **Ajouter**: Créez de nouveaux fichiers `.ps1` dans `scripts/`. Ils seront automatiquement ajoutés au XML lors de la compilation.
