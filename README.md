...
*   **🛡️ Privacy Hardened**: Disables Telemetry, **Location Tracking**, **Delivery Optimization** (P2P Updates), **Recall** (AI Screenshot), Copilot, Bing Search, Cortana, Advertising ID, **Search Highlights**, **Widgets**, **File Explorer Ads**, **Tips/Suggestions**, **Error Reporting**, **Shared Experiences**, and **Typing Insights**. **Restores Classic Context Menu** (Windows 11) and shows file extensions by default.
*   **🌑 Dark Mode**: Enables Dark Mode for System and Apps by default.
*   **🧹 Deep Debloating**: Aggressively removes bloatware (Candy Crush, Clipchamp, **Zune**, **Bing Apps**, **Widgets**, **Cortana**, **Xbox/Gaming Overlays**, **YourPhone**, **Meet Now** icon, etc.) and unnecessary Windows capabilities. **Preserves Notepad and Paint.**
*   **💥 Self-Destruct**: Installation scripts automatically delete themselves cleanly via PowerShell after the first login to ensure a clean slate.
...
*   **🚀 System Optimization**:
    ...
    *   **Power User**: Enables "End Task" in Taskbar context menu, shows **Seconds in System Clock**, Disables Transparency effects, and Disables **Mouse Acceleration**.
    ...
    *   **Space Saving**: Disables Hibernation to save disk space (`hiberfil.sys`) and explicitly disables **Fast Startup**.
...
*   **🛡️ Confidentialité Renforcée**: Désactive la télémétrie, **le Suivi de Localisation**, **l'Optimisation de Distribution** (Mises à jour P2P), **Recall** (Capture d'écran IA), Copilot, la recherche Bing, Cortana, l'ID publicitaire, **Widgets**, **Publicités Explorateur**, **Astuces**, **Rapports d'erreurs**, **Expériences partagées** et **Insights de saisie**. **Restaure le menu contextuel classique** (Windows 11) et affiche les extensions de fichiers.
*   **🌑 Mode Sombre**: Active le mode sombre pour le système et les applications par défaut.
*   **🧹 Nettoyage en Profondeur**: Supprime agressivement les bloatwares (Candy Crush, Clipchamp, **Zune**, **Applications Bing**, **Widgets**, **Cortana**, **Xbox/Jeux**, **YourPhone**, **Meet Now**, etc.) et les fonctionnalités Windows inutiles. **Préserve Notepad et Paint.**
*   **💥 Auto-destruction**: Les scripts d'installation se suppriment automatiquement proprement via PowerShell après la première connexion pour garantir un état propre.
...
*   **🚀 Optimisation Système**:
    ...
    *   **Utilisateur Avancé**: Active "Fin de tâche" dans le menu contextuel, affiche les **Secondes dans l'horloge**, désactive la transparence et désactive l'**Accélération de la souris**.
    ...
    *   **Gain d'Espace**: Désactive l'hibernation pour économiser de l'espace disque (`hiberfil.sys`) et désactive explicitement le **Démarrage Rapide**.
