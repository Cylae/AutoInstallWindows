...
*   **🛡️ Enhanced Robustness**:
    ...
    *   **Advanced Error Handling**: Improved logging and custom `Set-RegistryKey` function instead of `reg.exe` for robust registry changes.
...
*   **🛡️ Robustesse Améliorée**:
    ...
    *   **Gestion d'Erreurs Avancée**: Journaux améliorés et utilisation d'une fonction personnalisée `Set-RegistryKey` au lieu de `reg.exe` pour des modifications de registre robustes.
