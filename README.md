...
*   **Linting**: Run `flake8 .` to enforce PEP 8 style guidelines (max line length 79).
*   **Formatting**: Run `autopep8 --in-place --aggressive --aggressive <file>` to automatically format Python files.
...
*   **Linting** : Exécutez `flake8 .` pour appliquer les directives de style PEP 8 (longueur maximale de ligne 79).
*   **Formatage** : Exécutez `autopep8 --in-place --aggressive --aggressive <fichier>` pour formater automatiquement les fichiers Python.
*   **Tests** : Exécutez `pytest` pour exécuter les tests unitaires.
