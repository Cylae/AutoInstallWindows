...
*   **🛡️ Enhanced Robustness**:
    ...
    *   **Advanced Error Handling**: Improved logging and robust registry management using the custom `Set-RegistryKey` helper function for fail-safe execution.
...
*   **🛡️ Robustesse Améliorée**:
    ...
    *   **Gestion d'Erreurs Avancée**: Journaux améliorés et gestion robuste du registre utilisant la fonction d'aide personnalisée `Set-RegistryKey` pour une exécution sans faille.
