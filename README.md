...
*   **Lint**: Run `flake8 .` to lint all Python scripts.
*   **Test**: Run `pytest` to run tests.
...
*   **Lint**: Exécutez `flake8 .` pour vérifier la qualité du code Python.
*   **Test**: Exécutez `pytest` pour lancer les tests.
